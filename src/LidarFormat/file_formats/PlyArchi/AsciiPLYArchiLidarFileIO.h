...
class AsciiPLYArchiLidarFileIO : public LidarFileIO
{
public:
    virtual ~AsciiPLYArchiLidarFileIO() {}
    ...
    friend boost::shared_ptr<AsciiPLYArchiLidarFileIO> createAsciiPLYArchiLidarFileReader();

private:
    AsciiPLYArchiLidarFileIO();
